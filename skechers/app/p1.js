...
function fitscreen() {
  ...
  $('.mybtn1').css('height', (0.65 * innerWidth) * (157 / 576) + 'px').css('margin-left', (-0.65 * innerWidth / 2) + 'px');
  $('.goTitle').css('height', (0.7 * innerWidth) * (90 / 855) + 'px').css('margin-left', (-0.7 * innerWidth / 2) + 'px');
